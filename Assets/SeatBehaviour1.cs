...
{
    public class SeatBehaviour1 : MonoBehaviour
    {
        ...
        public void updateIcons()
        {
            ...
            for (int i = 0; i < distances.Length; i++)
            {
                ...
                {
                    light_bar[i].color = new Color(217, 217, 217, 1);
                }


                if (noise_level > 0)
                {
                    noise_bar[i].color = new Color(92, 255, 166, 1);
                    noise_level--;
                }
                else
                {
                    noise_bar[i].color = new Color(217, 217, 217, 1);
                }


                if (thermal_level > 0)
                {
                    thermal_bar[i].color = new Color(92, 255, 166, 1);
                    thermal_level--;
                }
                else
                {
                    thermal_bar[i].color = new Color(217, 217, 217, 1);
                }
